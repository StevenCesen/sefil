    ...
    const handleDownload = async () => {
        ...
        try {
            await downloadExport({
                endpoint: 'exports/collection-expenses',
                params: { start_date, end_date, business_id },
                filename: 'gastos_cobranza.xlsx'
            });
        } catch {
            sendpush({
        ...
        <div className="ReportExport">
            <div className="ReportExport__container">
                <div className="ReportExport__header">
                    <h2 className="ReportExport__title">Facturación de gastos de cobranza</h2>
                    <p className="ReportExport__subtitle">Exportar gastos de cobranza por rango de fechas</p>
                </div>

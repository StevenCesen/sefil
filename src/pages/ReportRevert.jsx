...
export default function ReportRevert(){
    ...
    return (
        <div className="Reports">
            ...
            <h4 className="Reports__title">Pagos Revertidos</h4>
                <div className="Reports__filters Reports__filters--columns-5">
                    ...
                    <NavLink 
                        ...
                        onClick={(e)=>{
                            ...
                            location.href=`${import.meta.env.VITE_URL_BASE}/greverse?cartera=${empresa}&user=${localStorage.getItem('name')}&fecha_inicio=${inicio}&fecha_final=${final}`;
                        }}

...
const allSections = [
    ...
    { section: 'campains', label: 'Campañas' },
    { section: 'users', label: 'Usuarios' },
    { section: 'templates', label: 'Configuración - Control estados gestión' },
    { section: 'businesses', label: 'Configuración - Carteras' },
    { section: 'import_payments', label: 'Configuración - Carga de pagos' },
    { section: 'cartera_update', label: 'Actualización cartera' },
    { section: 'calls', label: 'Llamadas' },
    { section: 'payments', label: 'Pagos' },
    { section: 'report_cash_payments', label: 'Reporte - Pagos en efectivo' },
    { section: 'report_reversed_payments', label: 'Reporte - Pagos revertidos' },
    { section: 'report_collection_billing', label: 'Reporte - Facturación gastos cobranza' },
    { section: 'report_condonations', label: 'Reporte - Condonaciones' },
    { section: 'report_accounting_payments', label: 'Reporte - Pagos contabilidad' },
    { section: 'report_legal_payments', label: 'Reporte - Pagos proceso legal' },
    { section: 'report_judicial_expenses', label: 'Reporte - Gastos judiciales cargados' },
    { section: 'report_agreement_status', label: 'Reporte - Estado de convenios' },
    { section: 'report_payments_management', label: 'Reporte - Pagos con gestión' },
    { section: 'report_faces_management', label: 'Reporte - Gestión FACES' },
    { section: 'report_portfolio_status', label: 'Reporte - Estado de cartera (SEFIL)' },
    { section: 'report_credits_evolution', label: 'Reporte - Evolución créditos y pagos' },
    { section: 'report_campaign_assignment', label: 'Reporte - Asignación de campaña' },
...
const allAbilities = {
    ...
    certificados: ['certificados:view'],
    ...
    import_payments: ['import_payments:view'],
    report_cash_payments: ['report_cash_payments:view'],
    report_reversed_payments: ['report_reversed_payments:view'],
    report_collection_billing: ['report_collection_billing:view'],
    report_condonations: ['report_condonations:view'],
    report_accounting_payments: ['report_accounting_payments:view'],
    report_legal_payments: ['report_legal_payments:view'],
    report_judicial_expenses: ['report_judicial_expenses:view'],
    report_agreement_status: ['report_agreement_status:view'],
    report_payments_management: ['report_payments_management:view'],
    report_faces_management: ['report_faces_management:view'],
    report_portfolio_status: ['report_portfolio_status:view'],
    report_credits_evolution: ['report_credits_evolution:view'],
    report_campaign_assignment: ['report_campaign_assignment:view'],
};

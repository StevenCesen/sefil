...
export default function CardDial({channel,phone_number,credit_id,campain_id}){
    ...
    const handlerDial=(channel)=>{
        store_call.setInCall(true);
        store_call.setMessage('En llamada con:')
    ...
    return (
        <div className={`CardDial ${(store_call.in_call) ? 'CardDial--incall' : ''}`}>
            ...
            <p className="CardDial__phone">{(phone_number!=='') ? `${store_call.message_status} ${phone_number}` : ''}</p>
                    ...
                    ?
                        <>
                            <label 
                                ...
                                onClick={()=>{handlerDial()}}><PhoneForwarded size={18}
                            /></label>
                            <label 
